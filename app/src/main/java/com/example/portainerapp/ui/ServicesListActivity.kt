...
class ServicesListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lateinit var adapter: com.example.portainerapp.ui.adapters.ServiceAdapter
        adapter = com.example.portainerapp.ui.adapters.ServiceAdapter(
            onOpen = { svc ->
                ...
                for (id in ids) {
                    runCatching {
                        ...
                        if (spec != null) {
                            ...
                            val newSpec = com.example.portainerapp.network.ServiceSpecFull(spec.Name, newTask)
