...
import com.agreenbhm.vibetainer.network.DockerNode
import com.agreenbhm.vibetainer.ui.NodeDetailActivity
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        com.agreenbhm.vibetainer.ui.EdgeToEdge.apply(this, toolbar, findViewById(R.id.swipe_refresh))

        val recycler = findViewById<RecyclerView>(R.id.recycler_nodes)
        recycler.layoutManager = LinearLayoutManager(this)
        val adapter = NodesAdapter { node ->
            val intent = Intent(this, com.agreenbhm.vibetainer.ui.NodeDetailActivity::class.java)
        ...
        if (endpointId <= 0) {
            startActivity(Intent(this, com.agreenbhm.vibetainer.ui.EndpointListActivity::class.java))
            finish()
            return
        }
            ...
            lifecycleScope.launch {
                try {
                    ...
                    Snackbar.make(recycler, "Failed to load nodes", Snackbar.LENGTH_LONG)
                        ...
                        .setAction("Settings") {
                            startActivity(Intent(this@MainActivity, com.agreenbhm.vibetainer.ui.EndpointListActivity::class.java))
                        }
                        .show()
                } finally {
...
class NodeVH(itemView: android.view.View, private val onClick: (DockerNode) -> Unit) : RecyclerView.ViewHolder(itemView) {
    ...
    fun bind(item: DockerNode, running: Int, total: Int, endpointId: Int, agentTarget: String?) {
        ...
        chipRunning.setOnClickListener {
            val i = Intent(ctx, com.agreenbhm.vibetainer.ui.NodeContainersActivity::class.java)
