...
class NodeContainersActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Show node hostname as subtitle when viewing a specific node; otherwise endpoint name
        toolbar.subtitle = agentTarget ?: com.agreenbhm.vibetainer.util.Prefs(this).endpointName()
        ...
        var baseForNode: List<com.agreenbhm.vibetainer.network.ContainerSummary> = emptyList()
    ...
    private fun confirmRemoveSelected(
        ...
        api: com.agreenbhm.vibetainer.network.PortainerService,
        endpointId: Int,
        agentTarget: String?
    ) {
